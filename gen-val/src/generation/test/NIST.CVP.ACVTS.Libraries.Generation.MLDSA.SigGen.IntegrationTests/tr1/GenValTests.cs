...
namespace NIST.CVP.ACVTS.Libraries.Generation.MLDSA.SigGen.IntegrationTests.tr1;
...
public class GenValTests : GenValTestsSingleRunnerBase
{
    ...
    public override string Revision { get; set; } = "FIPS204-tr1";
    
    public override AlgoMode AlgoMode => AlgoMode.ML_DSA_SigGen_FIPS204_tr1;
