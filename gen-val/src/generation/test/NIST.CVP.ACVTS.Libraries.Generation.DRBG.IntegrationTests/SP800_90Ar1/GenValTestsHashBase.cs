            ...
            var p = new Parameters
            {
                ...
                Capabilities = new[]
                {
                    new Capability
                    {
                        ...
                        ReturnedBitsLen = new MathDomain().AddSegment(new ValueDomainSegment(SeedLength[index] * 4)),
                    },
                    new Capability
                    {
                        ...
                        ReturnedBitsLen = new MathDomain().AddSegment(new ValueDomainSegment(SeedLength[otherIndex] * 8)),
                    }
                }
            };
        ...
        protected override string GetTestFileLotsOfTestCases(string targetFolder)
        {
            ...
            for (var i = 0; i < Modes.Length; i++)
            {
                capabilities[i] = new Capability
                {
                    ...
                    ReturnedBitsLen = new MathDomain().AddSegment(new ValueDomainSegment(512)).AddSegment(new ValueDomainSegment(768)),
                };
            }
