...
namespace NIST.CVP.ACVTS.Libraries.Generation.DRBG.IntegrationTests.SP800_90Ar1
{
    ...
    public class GenValTestsCtr : GenValTestsDrbgBase
    {
        ...
        public override string Revision => "SP800-90Ar1";
        ...
        public override AlgoMode AlgoMode => AlgoMode.ctrDRBG_SP800_90Ar1;
    }
    ...
    public class GenValTestsHash : GenValTestsHashBase
    {
        ...
        public override AlgoMode AlgoMode => AlgoMode.hashDRBG_SP800_90Ar1;
    }
    ...
    public class GenValTestsHMAC : GenValTestsHashBase
    {
        ...
        public override AlgoMode AlgoMode => AlgoMode.hmacDRBG_SP800_90Ar1;
    }
}
