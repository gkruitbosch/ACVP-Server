...
public class ParameterValidatorTests
{
    ...
    private static readonly object[] SpecificCapabilities =
    {
        ...
        new object[]
        {
            "valid params, expanded format only",
            new [] { SignatureInterface.Internal, SignatureInterface.External },
            new [] { PreHash.PreHash, PreHash.Pure },
            new [] { HashFunctions.Sha2_d256 },
            new MathDomain().AddSegment(new ValueDomainSegment(128)),
        ...
        new object[]
        {
            "No private key format provided",
            new [] { SignatureInterface.Internal, SignatureInterface.External },
            new [] { PreHash.PreHash, PreHash.Pure },
            new [] { HashFunctions.Sha2_d256 },
            new MathDomain().AddSegment(new ValueDomainSegment(128)),
    ...
    public void WhenGivenParameters_ShouldVerifyOnlyValidCombinations(string description, SignatureInterface[] signatureInterfaces, PreHash[] preHashes, HashFunctions[] hashFunctions, MathDomain contextLength, PrivateKeyFormat[] keyFormats, bool[] externalMu, bool expectedSuccess)
    {
