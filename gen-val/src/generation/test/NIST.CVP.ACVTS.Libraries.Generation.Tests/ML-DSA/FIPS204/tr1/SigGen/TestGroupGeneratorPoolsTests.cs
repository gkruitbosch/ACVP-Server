    ...
    [
        ...
        new object[] {
            ...
            new Parameters
            {
                ...
                KeyFormats = [PrivateKeyFormat.Seed]
            },
            0
        },
        new object[] {
            "0 groups - KeyFormats not included",
            new Parameters
            {
                ExternalMu = [false],
                SignatureInterfaces = [SignatureInterface.Internal],
        ...
        new object[] {
            ...
            new Parameters
            {
                ...
                Deterministic = [true],
                Capabilities = [new Capability { MessageLength = new MathDomain().AddSegment(new ValueDomainSegment(256)), ParameterSets = [DilithiumParameterSet.ML_DSA_44] }],
                KeyFormats = [PrivateKeyFormat.Expanded]
            },
            2
        },
        new object[] {
            "12 groups - all properties with everything",
            new Parameters
            {
                ...
                KeyFormats = [PrivateKeyFormat.Expanded, PrivateKeyFormat.Seed]
            },
            12
        }
    ];
