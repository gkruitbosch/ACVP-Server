...
using NIST.CVP.ACVTS.Libraries.Generation.DRBG.SP800_90Ar1.ContractResolvers;
...
namespace NIST.CVP.ACVTS.Libraries.Generation.DRBG.SP800_90Ar1
{
    public class RegisterInjections : ISupportedAlgoModeRevisions
    {
        ...
        {
            AlgoMode.ctrDRBG_SP800_90Ar1,
            AlgoMode.hashDRBG_SP800_90Ar1,
            AlgoMode.hmacDRBG_SP800_90Ar1
        };
