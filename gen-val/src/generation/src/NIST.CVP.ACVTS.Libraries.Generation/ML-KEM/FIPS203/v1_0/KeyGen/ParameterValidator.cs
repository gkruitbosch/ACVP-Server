...
namespace NIST.CVP.ACVTS.Libraries.Generation.ML_KEM.FIPS203.v1_0.KeyGen;

public class ParameterValidator : ParameterValidatorBase, IParameterValidator<Parameters>
{
    public static MLKEMParameterSet[] VALID_PARAMETER_SETS = EnumHelpers.GetEnums<MLKEMParameterSet>().Except(new [] { MLKEMParameterSet.None }).ToArray();
