...
public class TestCase : ITestCase<TestGroup, TestCase>
{
    ...
    public BitString DecapsulationKey { get; set; } // Used when using the ParentGroup.KeyFormat = expanded
    
    [JsonProperty(PropertyName = "z")]
    public BitString SeedZ { get; set; } // Used when using the ParentGroup.KeyFormat = seed
    
    [JsonProperty(PropertyName = "d")]
    public BitString SeedD { get; set; } // Used when using the ParentGroup.KeyFormat = seed
