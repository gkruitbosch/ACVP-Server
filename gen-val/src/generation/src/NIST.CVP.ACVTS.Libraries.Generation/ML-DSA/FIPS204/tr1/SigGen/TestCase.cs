...
public class TestCase : ITestCase<TestGroup, TestCase>
{
    ...
    public BitString PrivateKey { get; set; } // Used when using the ParentGroup.KeyFormat = expanded
    
    [JsonProperty(PropertyName = "seed")]
    public BitString Seed { get; set; } // Used when using the ParentGroup.KeyFormat = seed
